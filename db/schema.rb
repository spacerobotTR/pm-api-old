...
ActiveRecord::Schema.define(version: 2018_10_13_140347) do
  ...
  create_table "admin_installers", force: :cascade do |t|
  ...
  create_table "proj_statuses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["status_id"], name: "index_proj_statuses_on_status_id"
  end
